...
- (void)viewDidLoad
{
    ...
    loveLabel.text = @"❤ MetroMate 1.0.3, by Scapehouse.";
    ...
    aboutLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, disclaimerLabel.frame.origin.y + disclaimerLabel.frame.size.height + 124, 280, 270)];
    aboutLabel.textColor = [UIColor whiteColor];
    aboutLabel.text = @"ABOUT SCAPEHOUSE\n\n"
                        @"noun | Skāp ⋅ hous |\n\n"
                        @"It started out in 2011 as a hobby. We're doing this because we love building cool things that'll have an impact on people's lives.\n\n"
                        @"FOLLOW THE TEAM\n\n"
                        @"Ali •\n\n\n"
                        @"Diana •";    
    aboutLabel.font = [UIFont fontWithName:@"Georgia" size:MIN_MAIN_FONT_SIZE];
    aboutLabel.numberOfLines = 0;
    aboutLabel.backgroundColor = [UIColor clearColor];
    aboutLabel.opaque = YES;
    ...
    [socialProfilesButton_Ali setTitle:@"@MachOSX" forState:UIControlStateNormal];
    ...
    copyright.text = @"© 2014 Scapehouse. be original.";
    ...
    [backScrollView addSubview:aboutLabel];
